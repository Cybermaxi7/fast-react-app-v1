  ...
  return (
    <div className="space-y-8 px-4 py-6">
      ...
      <div className="space-y-2 bg-stone-200 px-6 py-5">
        <p className="text-sm font-medium text-stone600">Price pizza: {formatCurrency(orderPrice)}</p>
        {priority && <p className="text-sm font-medium text-stone600">Price priority: {formatCurrency(priorityPrice)}</p>}
